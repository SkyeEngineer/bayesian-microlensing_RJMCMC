...
my_data = mm.MulensData(data_list=[t, my_1S2L_model.magnification(t), my_1S2L_model.magnification(t)*0+0.03])
...
qaxis = np.linspace(0.001, 0.5, 20)
saxis = np.linspace(1, 2, 20)
